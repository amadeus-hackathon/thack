Aria.tplScriptDefinition({
    ...
    $prototype: {
        ...
        getPlaceInformation: function (criteriaData) {
            ...
            var that = this;
            var url = "http://1.hackathon-amadeus.appspot.com/GetTopEvents?date=Future Date&keywords=" + keywordData + " || " + medListData + regionName + "&sort_order=popularity&sort_order=ascending&max_cities=3&max_events=3&lat=" + window.localStorage.getItem("gpsLat") + "&lng=" + window.localStorage.getItem("gpsLng") + "&api_type=0";
                                    ...
                                    if (textStatus == "success") {
                                        ...
                                        $.ajax({
                                            ...
                                            complete: function (responseData, textStatus, jqXHR) {
                                                ...
                                                if (textStatus == "success" && responseData.responseText != null && responseData.responseText != '') {
